                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center">
                                        <div class="p-5">
                                            ...
                                            <p>Secara kelompok membuat aplikasi manajemen waktu yang dirancang untuk membantu pengguna, terutama pelajar. Dibuat dengan tujuan untuk menciptakan solusi yang meningkatkan efisiensi pengguna dalam mengelola waktu, dengan fitur seperti pengingat, kalender, dan analisis waktu.</p>
                                        </div>
                                        <img class="img-fluid" src="assets/didik.jpg" alt="..." />
                                    </div>
                                </div>
                            </div>
                        </div>
